        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden bg-background">
            ...
            <div className="relative z-10 w-full max-w-7xl px-6 text-center">
                ...
                >
                    ...
                    <h1 className="text-[40px] sm:text-[60px] md:text-[80px] lg:text-[100px] font-black font-outfit text-foreground uppercase leading-[0.95] md:leading-[0.9] tracking-[-0.04em] mb-6 md:mb-8">
                        Build. Play. <span className="text-spark-lime">Spark</span><br />
                        the <span className="inline-block relative">
                            Future
                            <div className="absolute -bottom-1 md:-bottom-2 left-0 w-full h-1.5 md:h-2 bg-spark-lime rounded-full" />
                        </span>
                    </h1>

                    <p className="text-base sm:text-lg md:text-xl text-muted-foreground font-lexend mb-10 md:mb-16 max-w-2xl mx-auto leading-tight tracking-tight px-4 sm:px-0">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 px-6 sm:px-0">
                        <Button className="w-full sm:w-auto bg-foreground text-background hover:bg-foreground/90 rounded-full px-8 md:px-12 py-6 md:py-8 text-xs md:text-sm font-black uppercase tracking-widest shadow-2xl transition-all hover:scale-105 group">
                            Start Building
                            <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                        </Button>
                        <Button variant="outline" className="w-full sm:w-auto rounded-full px-8 md:px-10 py-6 md:py-8 text-xs md:text-sm font-black border-2 border-foreground/5 hover:bg-foreground/5 transition-all gap-3 uppercase tracking-widest">
